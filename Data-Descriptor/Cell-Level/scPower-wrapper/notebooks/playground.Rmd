...
params: 
    ...
    results_path: "C:/Users/Cem/Documents/GitHub/Helmholtz-Workspace/Data-Descriptor/Cell-Level/scPower-wrapper/results/prostate/AllCells/"
    dataset_path: "UrethralLuminalEpithelia_AllCells.rds"
title: |
...
```{r}
  for(datasetID in datasetCollectionCombinedID){
      ...
      error = function(e) {
        ...
        colnames(errorDF)[4] <- "errorMessage"
      ...
      # code to execute in case there is no error
  }
```
