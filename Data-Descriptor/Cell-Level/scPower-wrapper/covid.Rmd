---
params: 
    collection_name: "Sampling peripheral blood and matched nasal swabs from donors with prior immunodeficiencies and autoimmune conditions infected with SARS-CoV-2"
    dataset_name: "Autoimmunity PBMCs"
    link: "https://cellxgene.cziscience.com/collections/eb735cc9-d0a7-48fa-b255-db726bf365af"
title: |
...
outputResults <- function(dataFrame, fileName) {
  resultPath <- "C:/Users/Cem/Documents/GitHub/Helmholtz-Workspace/Data-Descriptor/Cell-Level/scPower-wrapper/results/covid/"
...
```{r}
  ...
  datasetFilePath <- "autoimmunityPBMCs_blood_covid_1_homosap_97499.h5seurat"
