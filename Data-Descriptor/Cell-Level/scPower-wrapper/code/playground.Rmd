...
```{r}
  ...
  path <- "C:/Users/Cem/Documents/GitHub/Helmholtz-Workspace/Data-Descriptor/Cell-Level/scPower-wrapper/results"
  
  # get a list of all .txt files in the directory and subdirectories
  files <- list.files(path, recursive = TRUE, pattern = "^descriptiveParams\\.txt$", full.names = TRUE)
  
  # Read the file as a data frame
  df <- read.table(files[[1]], sep = " ", header = TRUE, stringsAsFactors = FALSE)
